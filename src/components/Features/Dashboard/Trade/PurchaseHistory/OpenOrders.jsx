      ...
      <TableRow className="odd:h-[88px] even:h-16">
        ...
        <TableCell>
          <div className="inline-flex">
            <Button
              color="transparent"
              className="font-normal text-xs leading-normal w-[77px] h-9"
            >
              Cancel
            </Button>
            <Button
              color="success"
              className="font-normal text-xs leading-normal w-[77px] h-9 ml-[14px]"
            >
              Edit
            </Button>
          </div>
  ...
  return (
    <>
      ...
      <div className="block lg:hidden">
        {rows.map((row) => (
          <div
            className="flex items-center justify-between mb-3 border border-input-border dark:border-0 dark:bg-card-dark rounded-[5px] text-xs p-3"
            key={row.id}
          >
            <Tag
              label={row.type}
